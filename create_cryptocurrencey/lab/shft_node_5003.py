...
def mine_block():
    ...
    blockchain.add_transaction(
        sender=node_address, receiver="shifat", amount=1)
...
def connect_node():
    ...
    response = {
        "message": "All the nodes are now connected. The shft Blockchain now contains the following nodes : ",
...
def replace_chain():
    ...
    if chain_replaced:
        ...
        response = {
            "message": "All good, The chain is the largest",
